...
import (
	...
	"github.com/Serizao/go-winio/internal/interop"
)

//go:generate go run github.com/Serizao/go-winio/tools/mkwinsyscall -output zsyscall_windows.go computestorage.go
